...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            // Get chat revive settings
            const chatReviveSettings = await client.database.getChatReviveSettings();
            ...
            await client.database.saveChatReviveSettings(chatReviveSettings);
