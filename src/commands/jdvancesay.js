...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            await interaction.editReply({ content: '❌ Something went wrong generating JD\'s voice!' });
        }
    }
};
