    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    {
                        ...
                        value: `Using RFK Jr. voice model`,
                        inline: false
                    }
                )
                ...
                .setFooter({
                    text: `RFK Jr. Model ID: ${modelId} | Powered by Fish Audio`
                })
                .setTimestamp();
            ...
            await interaction.editReply({ content: '❌ Something went wrong generating RFK Jr.\'s voice!' });
        }
    }
};
